...
struct CameraTrigger sCamAa[] = {
	NULL_TRIGGER
};
struct CameraTrigger sCamDeliciousCake[] = {
	NULL_TRIGGER
};
struct CameraTrigger sCamHhh[] = {
	NULL_TRIGGER
};
struct CameraTrigger sCamFf[] = {
	NULL_TRIGGER
};
struct CameraTrigger sCamKtp[] = {
	NULL_TRIGGER
};
struct CameraTrigger sCamSr[] = {
	NULL_TRIGGER
};
struct CameraTrigger sCamSht[] = {
	NULL_TRIGGER
};
struct CameraTrigger sCamTsns[] = {
	NULL_TRIGGER
...
BAD_RETURN(s32) cutscene_enter_painting(struct Camera *c) {
    ...
    if (gRipplingPainting != NULL) {
        ...
        if ((floor->type < SURFACE_PAINTING_WOBBLE_A6) || (floor->type > SURFACE_PAINTING_WARP_TSNS3)) {
            c->cutscene = 0;
            gCutsceneTimer = CUTSCENE_STOP;
            sStatusFlags |= CAM_FLAG_SMOOTH_MOVEMENT;
        }
