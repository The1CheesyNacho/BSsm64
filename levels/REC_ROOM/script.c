...
const LevelScript level_REC_ROOM_entry[] = {
	...
	AREA(1, REC_ROOM_area_1),
		...
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -1090, 784, 407, 0, 0, 0,   0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -936, 784, 407, 0, -180, 0,   0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -427, 784, 407, 0, -180, 0,   0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -581, 784, 407, 0, 0, 0,   0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 250, 784, 1244, 0, 90, 0,   0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 250, 784, 1090, 0, -90, 0,   0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 250, 784, 1752, 0, 90, 0,   0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 250, 784, 1598, 0, -90, 0,   0x00000000, bhvDoor),
