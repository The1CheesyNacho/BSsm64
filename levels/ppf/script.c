...
const LevelScript level_ppf_entry[] = {
	...
	AREA(1, ppf_area_1),
		...
		OBJECT(MODEL_THI_WARP_PIPE, -1112, 3082, -1762, 0, 0, 0, 0x000B0000, bhvWarpPipe),
		OBJECT(MODEL_STAR, -94, 3267, -2525, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_GOOMBA, -120, -1713, 6160, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_CHAIN_CHOMP, -3181, 2853, -107, 0, 0, 0, 0x00000000, bhvChainChomp),
