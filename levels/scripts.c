...
#include "levels/bbf/header.h"
#include "levels/yi/header.h"
#include "levels/bbf2/header.h"
#include "levels/dbd/header.h"
#include "levels/tc/header.h"
#include "levels/ddc/header.h"
#include "levels/mmm/header.h"
#include "levels/tsss/header.h"
#include "levels/ll/header.h"
#include "levels/faf/header.h"
#include "levels/gf/header.h"
#include "levels/ct/header.h"
#include "levels/ac/header.h"
#include "levels/www/header.h"
#include "levels/kbs/header.h"
#include "levels/bowser_4/header.h"
#include "levels/bowser_5/header.h"
#include "levels/bitft/header.h"
#include "levels/ef/header.h"
...
const LevelScript script_func_global_4[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_KING_BOO,                king_boo),
    RETURN(),
};
