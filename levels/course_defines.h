...
DEFINE_COURSE(COURSE_BHB, 0x44444440) // (14) Tick Tock Clock
DEFINE_COURSE(COURSE_TC, 0x44444440) // (14) Tick Tock Clock
DEFINE_COURSE(COURSE_DBD, 0x44444440) // (14) Tick Tock Clock
DEFINE_COURSE(COURSE_PO, 0x44444440) // (14) Tick Tock Clock
DEFINE_COURSE(COURSE_BOV, 0x44444440) // (14) Tick Tock Clock
DEFINE_COURSE(COURSE_SL, 0x02020240) // (10) Snowman's Land
DEFINE_COURSE(COURSE_WDW, 0x22102240) // (11) Wet-Dry World
DEFINE_COURSE(COURSE_PPV, 0x44444440) 
DEFINE_COURSE(COURSE_SSS, 0x44444440) 
DEFINE_COURSE(COURSE_TTM, 0x00000040) // (12) Tall, Tall Mountain
DEFINE_COURSE(COURSE_THI, 0x11112140) // (13) Tiny Huge Island
DEFINE_COURSE(COURSE_TSNS, 0x44444440) // (14) Tick Tock Clock
DEFINE_COURSE(COURSE_CCB, 0x44444440) 
DEFINE_COURSE(COURSE_DDD2, 0x44444440) 
DEFINE_COURSE(COURSE_GF, 0x44444440) // (14) Tick Tock Clock
DEFINE_COURSE(COURSE_TTC, 0x22222240) // (14) Tick Tock Clock
DEFINE_COURSE(COURSE_RR, 0x00000040) // (15) Rainbow Ride
DEFINE_COURSE(COURSE_LL, 0x44444440) // (14) Tick Tock Clock
DEFINE_COURSE(COURSE_KBS, 0x44444440) // (14) Tick Tock Clock
DEFINE_COURSE(COURSE_HHH, 0x44444440) // (14) Tick Tock Clock
DEFINE_COURSE(COURSE_FAF, 0x44444440) // (14) Tick Tock Clock
DEFINE_COURSE(COURSE_DDC, 0x44444440) 
DEFINE_COURSE(COURSE_SS, 0x44444440) 
DEFINE_COURSE(COURSE_CT, 0x44444440) // (14) Tick Tock Clock
DEFINE_COURSE(COURSE_CW, 0x44444440) 
DEFINE_COURSE(COURSE_AC, 0x44444440) // (14) Tick Tock Clock
DEFINE_COURSE(COURSE_POP, 0x44444440) 
DEFINE_COURSE(COURSE_HH, 0x44444440) // (15) Rainbow Ride
DEFINE_COURSE(COURSE_DELICIOUS_CAKE, 0x44444440) 
DEFINE_COURSES_END()
...
DEFINE_BONUS_COURSE(COURSE_BITFT, 0x44444440) // (16) Bowser in the Dark World
DEFINE_BONUS_COURSE(COURSE_EF, 0x44444440) // (16) Bowser in the Dark World
