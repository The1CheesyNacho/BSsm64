...
DEFINE_COURSE(COURSE_YI, 0x44444440) //
...
DEFINE_COURSE(COURSE_DDC, 0x44444440) // (14) Tick Tock Clock
DEFINE_COURSE(COURSE_MMM, 0x44444440) // (14) Tick Tock Clock
...
DEFINE_COURSE(COURSE_WWW, 0x44444440) // (14) Tick Tock Clock
DEFINE_COURSE(COURSE_HH, 0x44444440) // (15) Rainbow Ride
DEFINE_COURSE(COURSE_BBF2, 0x44444440) // (15) Rainbow Ride
DEFINE_COURSES_END()
