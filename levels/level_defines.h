...
DEFINE_LEVEL("KARON SABAKU", LEVEL_DBD, COURSE_DBD, dbd, generic, 20000, 0x00, 0x00, 0x00, _, sCamDbd) 
...
DEFINE_LEVEL("ATSUI GENGU", LEVEL_BHB, COURSE_BHB, bhb, generic, 20000, 0x00, 0x00, 0x00, _, sCamBhb) 
DEFINE_LEVEL("DONKEY % SLID2", LEVEL_TTM, COURSE_TTM, ttm, mountain, 15000, 0x08, 0x08, 0x08, _, _) 
DEFINE_LEVEL("YUDO DOKU", LEVEL_TC, COURSE_TC, tc, generic, 20000, 0x00, 0x00, 0x00, _, sCamTc) 
DEFINE_LEVEL("OASIS", LEVEL_PO, COURSE_PO, po, generic, 20000, 0x00, 0x00, 0x00, sDynUnk38, sCamDdc) 
DEFINE_LEVEL("BOMUHEI-MURA", LEVEL_BOV, COURSE_BOV, bov, generic, 20000, 0x00, 0x00, 0x00, _, sCamBov) 
DEFINE_LEVEL("HOSHIZORA", LEVEL_TSNS, COURSE_TSNS, tsns, generic, 20000, 0x00, 0x00, 0x00, sDynUnk38, sCamTSNS) 
DEFINE_LEVEL("PIRANHA VAL", LEVEL_PPV, COURSE_PPV, ppv, generic, 20000, 0x00, 0x00, 0x00, _, sCamPpv) 
DEFINE_LEVEL("TUSKI NO FOKEI", LEVEL_LL, COURSE_LL, ll, generic, 20000, 0x00, 0x00, 0x00, sDynUnk38, sCamLl) 
DEFINE_LEVEL("FAIN ATO", LEVEL_FAF, COURSE_FAF, faf, generic, 20000, 0x00, 0x00, 0x00, sDynUnk38, sCamFaf) 
DEFINE_LEVEL("SUGAR", LEVEL_SSS, COURSE_SSS, sss, generic, 20000, 0x00, 0x00, 0x00, _, sCamSss) 
DEFINE_LEVEL("GURABIYA KOJO", LEVEL_GF, COURSE_GF, gf, generic, 20000, 0x00, 0x00, 0x00, sDynUnk38, sCamGf) 
DEFINE_LEVEL("KUROMA TANDORA", LEVEL_CT, COURSE_CT, ct, generic, 20000, 0x00, 0x00, 0x00, sDynUnk38, sCamCt) 
DEFINE_LEVEL("BIRIKYU DOKUTSU", LEVEL_AC, COURSE_AC, ac, generic, 20000, 0x00, 0x00, 0x00, sDynUnk38, sCamAc) 
DEFINE_LEVEL("NOKONOKO SUTAJIO", LEVEL_KBS, COURSE_KBS, kbs, generic, 20000, 0x00, 0x00, 0x00, sDynUnk38, sCamKbs) 
DEFINE_LEVEL("TENKU NO KOGEN", LEVEL_HH, COURSE_HH, hh, generic, 20000, 0x00, 0x00, 0x00, sDynUnk38, sCamHh) 
DEFINE_LEVEL("KUPPA4", LEVEL_BOWSER_4, COURSE_BITFT, bowser_4, generic, 20000, 0x00, 0x00, 0x00, sDynUnk38, sCamBowser4) 
DEFINE_LEVEL("KUPPA5", LEVEL_BOWSER_5, COURSE_EF, bowser_5, generic, 20000, 0x00, 0x00, 0x00, sDynUnk38, sCamBowser5) 
DEFINE_LEVEL("TENPESUTO", LEVEL_BITFT, COURSE_BITFT, bitft, generic, 20000, 0x00, 0x00, 0x00, sDynUnk38, sCamBitft) 
DEFINE_LEVEL("EIEN NO TORIDE", LEVEL_EF, COURSE_EF, ef, generic, 20000, 0x00, 0x00, 0x00, sDynUnk38, sCamEf) 
DEFINE_LEVEL("RECORDING", LEVEL_REC_ROOM, COURSE_NONE, REC_ROOM, generic, 20000, 0x00, 0x00, 0x00, _, sCamRecRoom) 
DEFINE_LEVEL("DDD2", LEVEL_DDD2, COURSE_DDD2, ddd2, generic, 20000, 0x00, 0x00, 0x00, _, sCamDdd2) 
DEFINE_LEVEL("PUKUPUKUBEI", LEVEL_CCB, COURSE_CCB, ccb, generic, 20000, 0x00, 0x00, 0x00, _, sCamCcb) 
DEFINE_LEVEL("HHH", LEVEL_HHH, COURSE_HHH, hhh, generic, 20000, 0x00, 0x00, 0x00, _, sCamHHH) 
DEFINE_LEVEL("DDC", LEVEL_DDC, COURSE_DDC, ddc, generic, 20000, 0x00, 0x00, 0x00, _, sCamDdc) 
