...
DEFINE_LEVEL("HOSHIZORA", LEVEL_TSSS, COURSE_TSSS, tsss, generic, 20000, 0x00, 0x00, 0x00, sDynUnk38, sCamTsss) 
...
DEFINE_LEVEL("ET", LEVEL_ET, COURSE_ET, et, generic, 20000, 0x00, 0x00, 0x00, _, sCamEt) 
