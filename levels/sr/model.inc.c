Lights1 sr_dl_sm64_material_001_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFF,0xFF,0xFF,0x28,0x28,0x28);

Vtx sr_dl_Cube_mesh_layer_1_vtx_0[24] = {
...
Gfx sr_dl_Cube_mesh_layer_1_tri_0[] = {
	gsSPVertex(sr_dl_Cube_mesh_layer_1_vtx_0 + 0, 16, 0),
	...
	gsSPVertex(sr_dl_Cube_mesh_layer_1_vtx_0 + 16, 8, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSP1Triangle(4, 5, 6, 0),
	gsSP1Triangle(4, 6, 7, 0),
...
Gfx mat_sr_dl_sm64_material_001[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT, 0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsSPSetLights1(sr_dl_sm64_material_001_lights),
	gsSPEndDisplayList(),
};

Gfx sr_dl_Cube_mesh_layer_1[] = {
	gsSPDisplayList(mat_sr_dl_sm64_material_001),
	gsSPDisplayList(sr_dl_Cube_mesh_layer_1_tri_0),
	gsSPEndDisplayList(),
};
