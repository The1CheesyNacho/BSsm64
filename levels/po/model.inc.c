Lights1 po_dl_f3dlite_material_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFF, 0xFF, 0xFF, 0x28, 0x28, 0x28);

Vtx po_dl_Cube_mesh_layer_1_vtx_0[24] = {
...
Gfx po_dl_Cube_mesh_layer_1_tri_0[] = {
	gsSPVertex(po_dl_Cube_mesh_layer_1_vtx_0 + 0, 16, 0),
	...
	gsSPVertex(po_dl_Cube_mesh_layer_1_vtx_0 + 16, 8, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSP1Triangle(4, 5, 6, 0),
	gsSP1Triangle(4, 6, 7, 0),
...
Gfx mat_po_dl_f3dlite_material[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT, 0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsSPSetLights1(po_dl_f3dlite_material_lights),
	gsSPEndDisplayList(),
};

Gfx po_dl_Cube_mesh_layer_1[] = {
	gsSPDisplayList(mat_po_dl_f3dlite_material),
	gsSPDisplayList(po_dl_Cube_mesh_layer_1_tri_0),
	gsSPEndDisplayList(),
};

Gfx po_dl_material_revert_render_settings[] = {
	gsDPPipeSync(),
