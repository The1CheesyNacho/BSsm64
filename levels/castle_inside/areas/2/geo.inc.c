...
const GeoLayout castle_geo_001578[] = {
    GEO_NODE_START(),
    GEO_OPEN_NODE(),
        GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_inside_2_2_inside_castle_seg7_dl_07043028_mesh_mesh),
        GEO_DISPLAY_LIST(LAYER_OPAQUE, a_inside_castle_seg7_dl_07043B48_mesh_mesh),
