...
static const LevelScript script_func_local_1[] = {
    ...
    WARP_NODE(/*id*/ WARP_NODE_03, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 4, /*destNode*/ WARP_NODE_0A, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ WARP_NODE_04, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 4, /*destNode*/ WARP_NODE_0B, /*flags*/ WARP_NO_CHECKPOINT),
...
static const LevelScript script_func_local_2[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  3538, 1766,  -400, /*angle*/ 0, 180, 0, /*bhvParam*/ BPARAM2(WARP_NODE_36), /*bhv*/ bhvPaintingStarCollectWarp),
		OBJECT( MODEL_NONE, -483, 1478, 1585, 0, 180, 0,   BPARAM2(WARP_NODE_38), bhvPaintingStarCollectWarp),
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -483, 1478, 1585, /*angle*/ 0, 1870, 0, /*bhvParam*/ BPARAM2(WARP_NODE_6C), /*bhv*/ bhvLaunchDeathWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  -483, 1478, 1585,  /*angle*/ 0,  180, 0, /*bhvParam*/ BPARAM2(WARP_NODE_6D), /*bhv*/ bhvLaunchDeathWarp),
...
static const LevelScript script_func_local_3[] = {
	...
	OBJECT( MODEL_CASTLE_KEY_DOOR, 3152, -1416, 3507, 0, -180, 0,   BPARAM2(WARP_NODE_18), bhvDoorWarp),
	OBJECT( MODEL_CASTLE_KEY_DOOR, 2998, -1416, 3507, 0, 0, 0,   BPARAM2(WARP_NODE_19), bhvDoorWarp),
    ...
    WARP_NODE(/*id*/ WARP_NODE_18, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 4, /*destNode*/ WARP_NODE_0A, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ WARP_NODE_19, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 4, /*destNode*/ WARP_NODE_0B, /*flags*/ WARP_NO_CHECKPOINT),
    RETURN(),
};
...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(4, _2b_area_1),
    WARP_NODE(/*id*/ WARP_NODE_0A, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 3, /*destNode*/ WARP_NODE_18, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ WARP_NODE_0B, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 3, /*destNode*/ WARP_NODE_19, /*flags*/ WARP_NO_CHECKPOINT),
    PAINTING_WARP_NODE(/*id*/ WARP_NODE_2D, /*destLevel*/ LEVEL_TC, /*destArea*/ 1, /*destNode*/ WARP_NODE_0A, /*flags*/ WARP_NO_CHECKPOINT),
    PAINTING_WARP_NODE(/*id*/ WARP_NODE_2E, /*destLevel*/ LEVEL_TC, /*destArea*/ 1, /*destNode*/ WARP_NODE_0A, /*flags*/ WARP_NO_CHECKPOINT),
    PAINTING_WARP_NODE(/*id*/ WARP_NODE_2F, /*destLevel*/ LEVEL_TC, /*destArea*/ 1, /*destNode*/ WARP_NODE_0A, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ WARP_NODE_64, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 4, /*destNode*/ WARP_NODE_64, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ WARP_NODE_32, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 4, /*destNode*/ WARP_NODE_32, /*flags*/ WARP_NO_CHECKPOINT),
        OBJECT( MODEL_CASTLE_KEY_DOOR, -3871, 6, -4665, 0, -180, 0,BPARAM2(WARP_NODE_0A), bhvDoorWarp),
		OBJECT( MODEL_CASTLE_KEY_DOOR, -4025, 6, -4665, 0, 0, 0,   BPARAM2(WARP_NODE_0B), bhvDoorWarp),
		OBJECT( MODEL_NONE, 8083, 209, -3015, 0, -180, 0,   BPARAM2(WARP_NODE_64), bhvPaintingDeathWarp),
		OBJECT( MODEL_NONE, 8083, 209, -3015, 0, -180, 0,   BPARAM2(WARP_NODE_32), bhvPaintingStarCollectWarp),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -1473, 6, -2156, 0, 90, 0,   0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -4476, 6, -1961, 0, -90, 0,   0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -4049, 6, 298, 0, 180, 0,   0x00000000, bhvDoor),
		TERRAIN(_2b_area_1_collision),
		ROOMS(_2b_area_1_collision_rooms),
		MACRO_OBJECTS(_2b_area_1_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_FLOOR_2B),
