...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(4, _2b_area_1),
		WARP_NODE(WARP_NODE_0A, LEVEL_CASTLE , 0x01, WARP_NODE_03, WARP_NO_CHECKPOINT),
		WARP_NODE(WARP_NODE_0B, LEVEL_CASTLE , 0x01, WARP_NODE_04, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -2851, 200, -1325, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE,  -2851, 200, -1325, 0, 0, 0, 0x000B0000, bhvSpinAirborneWarp),
