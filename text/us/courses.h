...
COURSE_ACTS(COURSE_YI, _("7 YOSHI ISLAND"),
       _("H0NEY MUSTARD")  , _("THE BIG HOUSE IN THE SKY")      , _("COINS AMASSED IN A MAZE"),
       _("SWINGIN' IN THE BREEZE")        , _("TRICKY TRIANGLES!")             , _("SOMEWHERE OVER THE RAINBOW"))       
...
COURSE_ACTS(COURSE_LLL, _(" 9 LETHAL LAVA LAND"),
...
COURSE_ACTS(COURSE_BBF, _("10 BLASTING BULLET FACTORY"),
...
COURSE_ACTS(COURSE_TSSS, _("19 THE STARRY NIGHT SKIES"),
...
COURSE_ACTS(COURSE_BBF2, _("30 BIG BO0'S FOREST"),
       _("PLUCK THE PIRANHA FLOWER")      , _("THE TIP TOP OF THE HUGE ISLAND"), _("REMATCH WITH KOOPA THE QUICK"),
       _("FIVE ITTY BITTY SECRETS")       , _("WIGGLER'S RED COINS")           , _("MAKE WIGGLER SQUIRM"))
