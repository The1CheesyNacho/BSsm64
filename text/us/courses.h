...
COURSE_ACTS(COURSE_HMC, _(" 7 HAZY MAZE CAVE"),
...
COURSE_ACTS(COURSE_LLL, _(" 8 LETHAL LAVA LAND"),
...
COURSE_ACTS(COURSE_SSL, _(" 9 SHIFTING SAND LAND"),
...
COURSE_ACTS(COURSE_DDD, _(" 10 DIRE, DIRE DOCKS"),
...
COURSE_ACTS(COURSE_SL, _("11 SNOWMAN'S LAND"),
...
COURSE_ACTS(COURSE_WDW, _("12 WET-DRY WORLD"),
...
COURSE_ACTS(COURSE_TTM, _("13 TALL, TALL MOUNTAIN"),
...
COURSE_ACTS(COURSE_THI, _("14 TINY-HUGE ISLAND"),
...
COURSE_ACTS(COURSE_TTC, _("15 TICK TOCK CLOCK"),
...
COURSE_ACTS(COURSE_RR, _("16 RAINBOW RIDE"),
